...
var ComboScreen = React.createClass({
  render: function() {
    return (
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.mainSection}>
          ...
          <Image
            source={getImageSource(this.props.market, 'det')}
            style={styles.detailsImage}
          />
          <View style={styles.rightPane}>
            <Text style={styles.marketTitle}>{this.props.market.title}</Text>
            <Text>{this.props.market.year}</Text>
            <View style={styles.mpaaWrapper}>
              <Text style={styles.mpaaText}>
                {this.props.market.mpaa_rating}
              </Text>
            </View>
            <Ratings ratings={this.props.market.ratings} />
          </View>
        </View>
        <View style={styles.separator} />
        <Text>
          {this.props.market.synopsis}
        </Text>
        <View style={styles.separator} />
        <Cast actors={this.props.market.abridged_cast} />
      </ScrollView>
    );
  },
});
