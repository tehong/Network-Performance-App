...
var NETWORK_BH_URL = 'http://52.20.201.145:3010/kpis/v1/network/all/busyHour/kpi';
*/
  ...
  getRestEndPoint: function() {
    ...
    if (!(global.restService && global.restService.networkPerfUrl && global.restService.networkBhUrl)) {
      var interval = this.setInterval(
        () => {
          if (this.props.entityName === "daily_average" && global.restService && global.restService.networkPerfUrl) {
            NETWORK_URL = global.restService.networkPerfUrl;
          } else if (this.props.entityName === "busy_hour" && global.restService && global.restService.networkBhPerfUrl) {
      ...
      if (this.props.entityName === "daily_average") {
        NETWORK_URL = global.restService.networkPerfUrl;
      } else if (this.props.entityName === "busy_hour") {
        NETWORK_URL = global.restService.networkBhUrl;
      }
      this.getAreas('area');
    }
