...
var ControlledRefreshableListView = React.createClass({
  propTypes: {
    ...
    listViewComponent: PropTypes.oneOfType([PropTypes.func, PropTypes.element]),
  },
  getDefaultProps() {
    return {
  ...
  getScrollResponder() {
    if (this.refs[LISTVIEW_REF] && this.refs[LISTVIEW_REF].getNativeListView) {
      return this.refs[LISTVIEW_REF].getNativeListView().getScrollResponder();
    } else {
      if (this.refs[LISTVIEW_REF] && this.refs[LISTVIEW_REF].getScrollResponder) {
  ...
  render() {
    if (this.props.listViewComponent) {
      ListView = this.props.listViewComponent;
    }
    return (
      <ListView
        {...this.props}
